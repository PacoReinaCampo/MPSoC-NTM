...
touch code/transformer/components/ntm_masked_multi_head_attention.vhd
touch code/transformer/components/ntm_masked_scaled_dot_product_attention.vhd
touch code/transformer/components/ntm_multi_head_attention.vhd
touch code/transformer/components/ntm_scaled_dot_product_attention.vhd
touch code/transformer/fnn/ntm_fnn.vhd
touch code/transformer/functions/ntm_layer_norm.vhd
touch code/transformer/functions/ntm_positional_encoding.vhd
touch code/transformer/inputs/ntm_inputs_vector.vhd
touch code/transformer/inputs/ntm_keys_vector.vhd
touch code/transformer/inputs/ntm_queries_vector.vhd
touch code/transformer/inputs/ntm_values_vector.vhd
touch code/transformer/lstm/ntm_activation_gate_vector.vhd
touch code/transformer/lstm/ntm_forget_gate_vector.vhd
touch code/transformer/lstm/ntm_hidden_gate_vector.vhd
touch code/transformer/lstm/ntm_input_gate_vector.vhd
touch code/transformer/lstm/ntm_lstm.vhd
touch code/transformer/lstm/ntm_output_gate_vector.vhd
touch code/transformer/lstm/ntm_state_gate_vector.vhd
touch code/transformer/top/ntm_controller.vhd
touch code/transformer/top/ntm_decoder.vhd
touch code/transformer/top/ntm_encoder.vhd
