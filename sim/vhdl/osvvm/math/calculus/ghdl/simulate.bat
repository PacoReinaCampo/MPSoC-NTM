...
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/calculus/ntm_calculus_pkg.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/calculus/ntm_calculus_stimulus.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/calculus/ntm_calculus_testbench.vhd
