...
add wave -noupdate /model_algebra_testbench/model_vector_multiplication_test/vector_multiplication/start_scalar_float_multiplier
add wave -noupdate /model_algebra_testbench/model_vector_multiplication_test/vector_multiplication/data_a_in_scalar_float_multiplier
add wave -noupdate /model_algebra_testbench/model_vector_multiplication_test/vector_multiplication/data_b_in_scalar_float_multiplier
add wave -noupdate /model_algebra_testbench/model_vector_multiplication_test/vector_multiplication/ready_scalar_float_multiplier
add wave -noupdate /model_algebra_testbench/model_vector_multiplication_test/vector_multiplication/data_out_scalar_float_multiplier
