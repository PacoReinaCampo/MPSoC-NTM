...
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/start_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/operation_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_a_in_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_b_in_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/ready_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_out_scalar_float_adder
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/overflow_out_scalar_float_adder

add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/start_scalar_float_divider
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_a_in_scalar_float_divider
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_b_in_scalar_float_divider
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/ready_scalar_float_divider
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/data_out_scalar_float_divider
add wave -noupdate /model_calculus_testbench/model_matrix_differentiation_test/matrix_differentiation/rest_out_scalar_float_divider
