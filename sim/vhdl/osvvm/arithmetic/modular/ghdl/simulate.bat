...
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/modular/ntm_modular_pkg.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/modular/ntm_modular_stimulus.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/math/modular/ntm_modular_testbench.vhd
