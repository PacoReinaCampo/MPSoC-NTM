...
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_controller.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_activation_gate_vector.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_forget_gate_vector.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_hidden_gate_vector.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_input_gate_vector.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_output_gate_vector.vhd
ghdl -a --std=08 ../../../../../../rtl/vhdl/controller/transformer/convolution/ntm_state_gate_vector.vhd
