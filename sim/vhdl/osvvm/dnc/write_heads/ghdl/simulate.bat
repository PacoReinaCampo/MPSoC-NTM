...
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/dnc/write_heads/dnc_write_heads_pkg.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/dnc/write_heads/dnc_write_heads_stimulus.vhd
ghdl -a --std=08 ../../../../../../bench/vhdl/code/osvvm/dnc/write_heads/dnc_write_heads_testbench.vhd
