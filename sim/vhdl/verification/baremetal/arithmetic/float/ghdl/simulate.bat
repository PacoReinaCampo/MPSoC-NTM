...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/math/float/ntm_float_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/math/float/ntm_float_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/math/float/ntm_float_testbench.vhd
