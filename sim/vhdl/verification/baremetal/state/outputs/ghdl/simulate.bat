...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/state/outputs/ntm_state_outputs_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/state/outputs/ntm_state_outputs_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/design/state/outputs/ntm_state_outputs_testbench.vhd
