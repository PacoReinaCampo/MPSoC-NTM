...
alias accelerator_standard_linear_verification_compilation {
  ...
  vcom -2008 -reportprogress 300 -work work $verification_path/controller/linear/standard/accelerator_standard_linear_pkg.vhd
  vcom -2008 -reportprogress 300 -work work $verification_path/controller/linear/standard/accelerator_standard_linear_stimulus.vhd
  vcom -2008 -reportprogress 300 -work work $verification_path/controller/linear/standard/accelerator_standard_linear_testbench.vhd
