...
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/index_m_loop
...
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/start_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/operation_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_a_in_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_b_in_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/ready_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_out_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/overflow_out_scalar_float_adder

add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/start_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_a_in_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_b_in_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/ready_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/data_out_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_tensor_product_test/tensor_product/overflow_out_scalar_float_multiplier
