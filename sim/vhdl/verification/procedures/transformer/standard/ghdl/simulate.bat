...
ghdl -r --std=08 accelerator_standard_transformer_testbench --ieee-asserts=disable-at-0 --vcd=accelerator_standard_transformer_testbench.vcd --wave=system.ghw --stop-time=1ms
pause