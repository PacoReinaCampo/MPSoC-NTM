...
##################################################################################################
# accelerator_convolutional_fnn_design_compilation ####################################################
##################################################################################################

alias accelerator_convolutional_fnn_design_compilation {
  ...
  vcom -2008 -reportprogress 300 -work work $design_path/pkg/accelerator_fnn_controller_pkg.vhd
  ...
  vcom -2008 -reportprogress 300 -work work $design_path/controller/FNN/convolutional/accelerator_controller.vhd
}
