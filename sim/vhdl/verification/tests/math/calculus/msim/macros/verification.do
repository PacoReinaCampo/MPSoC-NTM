...
alias ntm_vector_differentiation_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_vector_differentiation.do
...
alias ntm_vector_integration_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_vector_integration.do
...
alias ntm_vector_softmax_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_vector_softmax.do
...
alias ntm_matrix_differentiation_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_matrix_differentiation.do
...
alias ntm_matrix_integration_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_matrix_integration.do
...
alias ntm_matrix_softmax_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_matrix_softmax.do
...
alias ntm_tensor_differentiation_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_tensor_differentiation.do
...
alias ntm_tensor_integration_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_tensor_integration.do
...
alias ntm_tensor_softmax_verification_compilation {
  ...
  do $simulation_path/design/math/calculus/msim/waves/ntm_tensor_softmax.do
