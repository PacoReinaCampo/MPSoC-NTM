...
alias ntm_scalar_float_adder_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_scalar_float_adder.do
...
alias ntm_scalar_float_multiplier_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_scalar_float_multiplier.do
...
alias ntm_scalar_float_divider_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_scalar_float_divider.do
...
alias ntm_vector_float_adder_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_vector_float_adder.do
...
alias ntm_vector_float_multiplier_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_vector_float_multiplier.do
...
alias ntm_vector_float_divider_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_vector_float_divider.do
...
alias ntm_matrix_float_adder_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_matrix_float_adder.do
...
alias ntm_matrix_float_multiplier_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_matrix_float_multiplier.do
...
alias ntm_matrix_float_divider_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_matrix_float_divider.do
...
alias ntm_tensor_float_adder_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_tensor_float_adder.do
...
alias ntm_tensor_float_multiplier_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_tensor_float_multiplier.do
...
alias ntm_tensor_float_divider_verification_compilation {
  ...
  do $simulation_path/design/arithmetic/float/msim/waves/ntm_tensor_float_divider.do
