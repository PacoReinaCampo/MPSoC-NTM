...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/ntm/write_heads/accelerator_write_heads_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/ntm/write_heads/accelerator_write_heads_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/ntm/write_heads/accelerator_write_heads_testbench.vhd
ghdl -m --std=08 accelerator_write_heads_testbench
ghdl -r --std=08 accelerator_write_heads_testbench --ieee-asserts=disable-at-0 --disp-tree=inst > accelerator_write_heads_testbench.tree
pause