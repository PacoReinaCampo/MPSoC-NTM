...
ghdl -a --std=08 ../../../../../../../bench/vhdl/test/ntm/memory/ntm_memory_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/test/ntm/memory/ntm_memory_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/test/ntm/memory/ntm_memory_testbench.vhd
