...
ghdl -a --std=08 ../../../../../../../../bench/vhdl/code/tests/model/controller/FNN/convolutional/model_convolutional_fnn_pkg.vhd
ghdl -a --std=08 ../../../../../../../../bench/vhdl/code/tests/model/controller/FNN/convolutional/model_convolutional_fnn_stimulus.vhd
ghdl -a --std=08 ../../../../../../../../bench/vhdl/code/tests/model/controller/FNN/convolutional/model_convolutional_fnn_testbench.vhd
