...
alias model_convolutional_linear_verification_compilation {
  ...
  #WAVES
  view -title model_convolutional_linear wave
  do $simulation_path/state/linear/convolutional/msim/waves/model_convolutional_linear.do
  ...
  dataset save sim model_convolutional_linear_test.wlf
}
