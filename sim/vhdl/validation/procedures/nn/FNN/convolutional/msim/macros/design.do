...
##################################################################################################
# model_convolutional_fnn_design_compilation
##################################################################################################

alias model_convolutional_fnn_design_compilation {
  ...
  vcom -2008 -reportprogress 300 -work work $design_path/pkg/model_fnn_controller_vhdl_pkg.vhd
  ...
  vcom -2008 -reportprogress 300 -work work $design_path/trainer/FNN/model_trainer.vhd

  vcom -2008 -reportprogress 300 -work work $design_path/controller/FNN/convolutional/model_controller.vhd
}
...
echo "****************************************"
echo "d01 . ACCELERATOR-CONVOLUTIONAL-FNN-TEST"
echo "****************************************"
