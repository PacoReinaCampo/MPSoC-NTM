...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/math/modular/model_modular_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/math/modular/model_modular_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/math/modular/model_modular_testbench.vhd
