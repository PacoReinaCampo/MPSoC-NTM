...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/math/calculus/ntm_calculus_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/math/calculus/ntm_calculus_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/math/calculus/ntm_calculus_testbench.vhd
