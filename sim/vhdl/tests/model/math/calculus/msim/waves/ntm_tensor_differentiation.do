...
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/start_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/operation_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_a_in_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_b_in_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/ready_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_out_scalar_integer_adder
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/overflow_out_scalar_integer_adder

add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/start_scalar_integer_divider
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_a_in_scalar_integer_divider
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_b_in_scalar_integer_divider
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/ready_scalar_integer_divider
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/data_out_scalar_integer_divider
add wave -noupdate /ntm_calculus_testbench/ntm_tensor_differentiation_test/tensor_differentiation/rest_out_scalar_integer_divider
