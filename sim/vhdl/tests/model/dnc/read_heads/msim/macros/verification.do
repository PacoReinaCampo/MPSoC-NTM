...
alias dnc_free_gates_verification_compilation {
  ...
  do $simulation_path/model/dnc/read_heads/msim/waves/dnc_free_gates.do
...
alias dnc_read_keys_verification_compilation {
  ...
  do $simulation_path/model/dnc/read_heads/msim/waves/dnc_read_keys.do
...
alias dnc_read_modes_verification_compilation {
  ...
  do $simulation_path/model/dnc/read_heads/msim/waves/dnc_read_modes.do
...
alias dnc_read_strengths_verification_compilation {
  ...
  do $simulation_path/model/dnc/read_heads/msim/waves/dnc_read_strengths.do
