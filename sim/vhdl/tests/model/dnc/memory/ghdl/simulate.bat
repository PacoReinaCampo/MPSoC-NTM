...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/model/dnc/memory/model_memory_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/model/dnc/memory/model_memory_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/model/dnc/memory/model_memory_testbench.vhd
