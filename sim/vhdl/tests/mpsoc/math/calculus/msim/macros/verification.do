...
alias ntm_vector_softmax_verification_compilation {
  ...
  do $simulation_path/mpsoc/math/calculus/msim/waves/ntm_vector_softmax.do
...
alias ntm_matrix_softmax_verification_compilation {
  ...
  do $simulation_path/mpsoc/math/calculus/msim/waves/ntm_matrix_softmax.do
...
alias ntm_tensor_softmax_verification_compilation {
  ...
  do $simulation_path/mpsoc/math/calculus/msim/waves/ntm_tensor_softmax.do
