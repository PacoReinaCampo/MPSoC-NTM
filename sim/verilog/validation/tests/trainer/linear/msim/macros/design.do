...
alias model_trainer_vector_differentiation_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/differentiation/model_trainer_vector_differentiation.sv
}
...
alias model_trainer_matrix_differentiation_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/differentiation/model_trainer_matrix_differentiation.sv
}
...
alias model_trainer_linear_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/state/linear/standard/model_controller.sv
}
