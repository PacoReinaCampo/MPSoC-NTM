...
alias model_convolutional_fnn_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/pkg/model_fnn_controller_verilog_pkg.sv
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/FNN/model_trainer.sv

  vlog -sv -reportprogress 300 -work work $design_path/controller/FNN/convolutional/model_controller.sv
}
