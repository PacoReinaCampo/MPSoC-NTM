...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/trainer/FNN/model_trainer_fnn_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/trainer/FNN/model_trainer_fnn_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/trainer/FNN/model_trainer_fnn_testbench.vhd

ghdl -e --std=08 model_trainer_fnn_testbench
ghdl -r --std=08 model_trainer_fnn_testbench --ieee-asserts=disable-at-0 --vcd=model_trainer_fnn_testbench.vcd --wave=system.ghw --stop-time=1ms
pause