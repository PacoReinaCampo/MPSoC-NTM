...
alias model_standard_linear_verification_compilation {
  ...
  #WAVES
  view -title model_standard_linear wave
  do $simulation_path/state/linear/standard/msim/waves/model_standard_linear.do
  ...
  dataset save sim model_standard_linear_test.wlf
}
