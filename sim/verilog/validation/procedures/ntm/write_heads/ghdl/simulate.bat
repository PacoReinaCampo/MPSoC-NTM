...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/ntm/write_heads/model_write_heads_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/ntm/write_heads/model_write_heads_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/baremetal/model/ntm/write_heads/model_write_heads_testbench.vhd
