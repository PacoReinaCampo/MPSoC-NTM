...
add wave -noupdate -divider {ACCELERATOR MATRIX PRODUCT TEST}
add wave -noupdate -divider {=========================================}
...
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/index_m_loop
...
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/start_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/operation_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_a_in_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_b_in_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/ready_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_out_scalar_float_adder
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/overflow_out_scalar_float_adder

add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/start_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_a_in_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_b_in_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/ready_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/data_out_scalar_float_multiplier
add wave -noupdate /accelerator_algebra_testbench/accelerator_matrix_product_test/matrix_product/overflow_out_scalar_float_multiplier
