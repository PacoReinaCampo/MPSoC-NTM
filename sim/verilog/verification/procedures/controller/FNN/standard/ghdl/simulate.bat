...
ghdl -m --std=08 accelerator_standard_fnn_testbench
ghdl -r --std=08 accelerator_standard_fnn_testbench --ieee-asserts=disable-at-0 --disp-tree=inst > accelerator_standard_fnn_testbench.tree
pause