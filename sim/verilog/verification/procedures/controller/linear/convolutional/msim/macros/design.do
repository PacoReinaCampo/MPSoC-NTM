...
alias accelerator_convolutional_linear_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/controller/linear/convolutional/accelerator_controller.sv
}
...
echo "****************************************"
echo "d01 . ACCELERATOR-CONVOLUTIONAL-LINEAR-TEST"
echo "****************************************"
