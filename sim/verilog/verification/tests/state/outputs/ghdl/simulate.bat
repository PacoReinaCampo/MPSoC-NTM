...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/state/outputs/accelerator_state_outputs_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/state/outputs/accelerator_state_outputs_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/state/outputs/accelerator_state_outputs_testbench.vhd
