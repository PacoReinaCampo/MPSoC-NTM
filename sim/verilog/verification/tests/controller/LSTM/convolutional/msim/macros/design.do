...
alias accelerator_convolutional_lstm_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/pkg/accelerator_lstm_controller_verilog_pkg.sv
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/LSTM/accelerator_trainer.sv

  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_controller.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_activation_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_forget_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_hidden_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_input_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_output_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/convolutional/accelerator_state_gate_vector.sv
}
...
echo "****************************************"
echo "d01 . ACCELERATOR-CONVOLUTIONAL-LSTM-TEST"
echo "****************************************"
