...
alias accelerator_standard_lstm_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_controller.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_activation_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_forget_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_hidden_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_input_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_output_gate_vector.sv
  vlog -sv -reportprogress 300 -work work $design_path/controller/LSTM/standard/accelerator_state_gate_vector.sv
}
