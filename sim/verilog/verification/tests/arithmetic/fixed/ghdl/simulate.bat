...
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/arithmetic/fixed/accelerator_fixed_pkg.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/arithmetic/fixed/accelerator_fixed_stimulus.vhd
ghdl -a --std=08 ../../../../../../../bench/vhdl/code/tests/design/arithmetic/fixed/accelerator_fixed_testbench.vhd
