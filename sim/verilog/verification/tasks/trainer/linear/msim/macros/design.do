...
##################################################################################################
# accelerator_trainer_linear_design_compilation
##################################################################################################

alias accelerator_trainer_linear_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/linear/accelerator_trainer.sv

  vlog -sv -reportprogress 300 -work work $design_path/state/linear/standard/accelerator_controller.sv
}
...
echo "****************************************"
echo "d01 . ACCELERATOR-TRAINER-LINEAR-TEST"
echo "****************************************"
