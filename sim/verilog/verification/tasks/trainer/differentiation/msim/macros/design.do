...
alias accelerator_trainer_vector_differentiation_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/pkg/accelerator_linear_controller_verilog_pkg.sv
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/differentiation/accelerator_trainer_vector_differentiation.sv
}
...
alias accelerator_trainer_matrix_differentiation_design_compilation {
  ...
  vlog -sv -reportprogress 300 -work work $design_path/trainer/differentiation/accelerator_trainer_matrix_differentiation.sv
}
...
echo "****************************************"
echo "d01 . ACCELERATOR-VECTOR-TRAINER-DIFFERENTIATION-TEST"
echo "d02 . ACCELERATOR-MATRIX-TRAINER-DIFFERENTIATION-TEST"
echo "****************************************"
