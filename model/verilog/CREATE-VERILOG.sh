...
touch code/transformer/fnn/model_fnn.sv
...
touch code/transformer/lstm/model_activation_gate_vector.sv
touch code/transformer/lstm/model_forget_gate_vector.sv
touch code/transformer/lstm/model_hidden_gate_vector.sv
touch code/transformer/lstm/model_input_gate_vector.sv
touch code/transformer/lstm/model_lstm.sv
touch code/transformer/lstm/model_output_gate_vector.sv
touch code/transformer/lstm/model_state_gate_vector.sv
