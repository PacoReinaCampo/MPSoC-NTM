...
touch code/classes/philosophers/ntm_philosophers/library/switch_if.sv
...
touch code/classes/soldiers/ntm_soldiers/library/switch_if.sv
...
touch code/classes/workers/ntm_workers/library/switch_if.sv
